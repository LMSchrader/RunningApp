...
data class RunHistoryEntryMetaDataWithMeasurements(
    ...
    object StaticFunctions {
        ...
        fun getDummyData(): List<RunHistoryEntryMetaDataWithMeasurements> {
            ...
            val dummy = RunHistoryEntryMetaDataWithMeasurements(dummyRunHistoryEntryMetaData, dummyRunHistoryMeasurementList)
            ...
            val dummy2 = RunHistoryEntryMetaDataWithMeasurements(dummy2RunHistoryEntryMetaData, dummy2RunHistoryMeasurementList)
